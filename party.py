...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'drink'}, {'type': 'drink'}, {'type': 'appetizer'}])
    ('dessert', 'appetizer')

    >>> most_and_least_common_type([{'type': 'brick'}, {'type': 'brick'}, {'type': 'computer monitor'}, {'type': 'computer monitor'}, {'type': 'mouse'}])
    ('brick', 'mouse')
    """
